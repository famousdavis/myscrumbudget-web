 ...
 *
 * Hand-copying with nothing asserting conformance is how the other eight drifted.
 * This repository was the exception: of the nine audited on 2026-07-29 it was the
 * ONLY one already byte-identical to the canonical file. That is worth guarding
 * rather than assuming — being correct once is not a mechanism, and every other
 * repo in the suite was correct at some point too. GanttApp shipped 48 lines and
 * spert-cfd 64, neither carrying the GNU GPL v3 at all; five carried a brand
 * retired in March 2026; six carried weaker additional terms; spert-ssv had no
...
const REPO_URL = 'https://github.com/famousdavis/myscrumbudget-web';
