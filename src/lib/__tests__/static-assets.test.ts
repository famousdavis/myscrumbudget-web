...
/**
 * The app hands users static files out of `public/` — the Quick Reference Guide and
 * Charter Budget Guide PDFs, and the favicons. Nothing holds the link and the file together: rename or drop one of
